...
RSpec.describe "Prettier Rails example" do
  include Rack::Test::Methods

  class PrettierTestApp < Rails::Application
    config.root = __dir__
    ...
    routes.draw do
      get "/prettier" => "prettier_test#prettier"
    end
  end

  class PrettierTestController < ActionController::Base
